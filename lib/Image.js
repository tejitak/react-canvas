...
var RawImage = createComponent('Image', LayerMixin, {
  ...
  applyImageProps: function (prevProps, props) {
    ...
    layer.imageScale = props.imageScale;
  },
...
var Image = React.createClass({
  ...
  propTypes: {
    ...
    imageScale: React.PropTypes.bool
  },
  ...
  render: function () {
    ...
    return (
      React.createElement(Group, {ref: 'main', style: style},
        ...
        React.createElement(RawImage, {ref: 'image', src: this.props.src, style: imageStyle, useBackingStore: useBackingStore, imageScale: this.props.imageScale})
      )
    );
  },
